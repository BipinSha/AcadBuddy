...
if (!fs.existsSync(input)) { console.log('WordPress export not present; skipping content import.'); process.exit(0); }
...
const text = (value) => { if (value == null) return ''; if (typeof value === 'object') return value.__cdata || value['#text'] || ''; return String(value); };
